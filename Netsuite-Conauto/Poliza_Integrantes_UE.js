                ...
                const afterSubmit = (scriptContext) => {
                        if (scriptContext.type == 'create' || scriptContext.type == 'edit' || scriptContext.type == 'xedit') {
                                ...
                                if (!journalId) {
                                        ...
                                        date = IMRParse.addDays(date, date.getDate() * -1);
                                        ...
                                        log.debug({
                                                title: "FIRST DATE REVERSAL",
                                                details: dateReversal
                                        })
                                        ...
                                        let memo = "PROVISION CARTAS DE CREDITO DE CLIENTES INTEGRANTES POR ADJUDICAR DEL MES " + mesTexto[date.getMonth()];;
                                        let type = "17";
